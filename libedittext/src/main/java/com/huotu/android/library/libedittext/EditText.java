 ...
 *
 */
public class EditText extends AutoCompleteTextView implements Callback{
	...
	public boolean handleMessage(Message msg) {
		if(!isFocusable())
			return true;
		EditText.this.setCompoundDrawables(EditText.this.getCompoundDrawables()[0], EditText.this.getCompoundDrawables()[1], null, EditText.this.getCompoundDrawables()[3]);
		if(msg.obj != null)
			EditText.this.setCompoundDrawables(EditText.this.getCompoundDrawables()[0], EditText.this.getCompoundDrawables()[1], (Drawable)msg.obj, EditText.this.getCompoundDrawables()[3]);
        ...
        this.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (!isShowError && event.getX() > et.getWidth() - et.getPaddingRight() - imgCloseButton.getIntrinsicWidth()) {
                    et.setText("");
                    EditText.this.handleClearButton();
                }
                return false;
            }
