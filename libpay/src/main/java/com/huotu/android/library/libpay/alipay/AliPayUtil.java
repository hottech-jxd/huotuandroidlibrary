...
//            + "";
    ...
    //
    public static final int  SDK_Ali_PAY_FLAG = 7001;
    ...
    public AliPayUtil( Activity context, Handler handler , AliPayInfo aliPayInfo ) {
        this.handler = handler;
        this.context = context;
        this.aliPayInfo = aliPayInfo;
    }

    public void pay( final AliOrderInfo aliOrderInfo ){


        // 订单
        final String orderInfo = getOrderInfo( aliOrderInfo );
        // 对订单做RSA签名
        ...
        Runnable payRunnable = new Runnable() {
            ...
            public void run() {
                ...
                AliPayResult aliPayResult = new AliPayResult( aliOrderInfo , result );
    ...
    private String sign(String content) {
        return new SignUtils().sign(content, aliPayInfo.getRsaPrivate() );
    }
     ...
     *
     */
    private String getOrderInfo( AliOrderInfo aliOrderInfo ) {
        // 签约合作者身份ID
        String orderInfo = "partner=" + "\"" + aliPayInfo.getPartner() + "\"";
        // 签约卖家支付宝账号
        orderInfo += "&seller_id=" + "\"" + aliPayInfo.getSellerId () + "\"";
        // 商户网站唯一订单号
        orderInfo += "&out_trade_no=" + "\"" + aliOrderInfo.getOrderNo() + "\"";
        // 商品名称
        orderInfo += "&subject=" + "\"" + aliOrderInfo.getSubject() + "\"";
        // 商品详情
        orderInfo += "&body=" + "\"" + aliOrderInfo.getBody() + "\"";
        // 商品金额
        orderInfo += "&total_fee=" + "\"" + String.valueOf( aliOrderInfo.getTotalfee() ) + "\"";
        // 服务器异步通知页面路径
